...
describe VendorSolution do
  ...
  describe "cal" do
    ...
    before do
      vendor_solution1.items.new(:parent_id=>d1.id,:price=>'10',:tax_rate=>'0.03').cal_save
      vendor_solution1.items.new(:parent_id=>d2.id,:price=>'15',:tax_rate=>'0.1').cal_save

      vendor_solution1.items.new(:parent_id=>p1.id,:price=>'10',:tax_rate=>'0.03').cal_save
      vendor_solution1.items.new(:parent_id=>p2.id,:price=>'15',:tax_rate=>'0.1').cal_save

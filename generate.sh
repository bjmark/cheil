...
#rails g migration drop_brief_vendors
#rails g migration add_self_right_to_comments
#rails generate controller brief_comments
...
#rails g migration add_brief_count_to_orgs
#rails generate controller vendor_stat
rails g migration add_score_to_items
